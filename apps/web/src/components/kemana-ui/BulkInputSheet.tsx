...
export default function BulkInputSheet({
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    "absolute inset-x-0 bottom-0 flex max-h-[90dvh] flex-col rounded-t-[24px] bg-bg-base shadow-2xl transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] sm:mx-auto sm:max-w-md",
