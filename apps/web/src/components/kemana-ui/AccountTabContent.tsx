                ...
                {!user ? (
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Button
                            ...
                            className="w-full flex items-center justify-center gap-2 rounded-2xl h-11 bg-brand/10 text-brand hover:bg-brand/15 border border-brand/20 transition-colors font-semibold"
                        >
